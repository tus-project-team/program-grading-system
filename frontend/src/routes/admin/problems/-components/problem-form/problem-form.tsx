    ...
    >
      ...
      <div>
        ...
        <form.Field mode="array" name="supported_languages">
          {(languages: {
            state: { value: { name: string; version: string }[] }
            removeValue: (index: number) => void
            pushValue: (value: { name: string; version: string }) => void
          }) => (
            <div className="space-y-4">
              ...
              <div className="flex items-end gap-2">
                ...
                <Button
                  ...
                  className="px-8"
                  onClick={() => {
                    const newLang = form.getFieldValue("newLanguage") as string
                    const newVer = form.getFieldValue("newVersion") as string
                    if (newLang && newVer) {
                      languages.pushValue({
                        name: newLang,
                        version: newVer,
